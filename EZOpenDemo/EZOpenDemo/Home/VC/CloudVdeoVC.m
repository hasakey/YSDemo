...
@interface CloudVdeoVC ()<DDCollectionViewDelegateFlowLayout, UICollectionViewDataSource,EZPlayerDelegate, UIAlertViewDelegate>
{
    BOOL _isOpenSound;
    BOOL _isPlaying;
...
//- (void)viewDidLoad {
//    [super viewDidLoad];
//    [self.titleView.title setTitle:@"视频列表" forState:UIControlStateNormal];
//    [self setUI];
...
//-(UIView *)playerView{
//    if (!_playerView) {
//        _playerView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.titleView.frame), M_WIDTH, M_WIDTH/16 * 9)];
//    }
//    return _playerView;
//}
//
...
//    if (!_largeTitleLabel) {
//        _largeTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.titleView.frame), M_WIDTH, 40)];
//    }
...
//    if (!_datePicker) {
//        _datePicker = [[UIDatePicker alloc] initWithFrame:CGRectMake(0, M_HEIGHT - 100, M_WIDTH, 100)];
//    }
//    return _datePicker;
//}
//
...
//    if (!_dateTextField) {
//        _dateTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, 100, TitleHeight)];
//    }
...
//    if (!_dateToolbar) {
//        _dateToolbar = [[UIToolbar alloc] initWithFrame:<#(CGRect)#>];
//    }
//}
//
//@property (nonatomic, weak) IBOutlet UIToolbar *dateToolbar;
